 ...
 */
metadata {
	definition (name: "Centralite Keypad II", namespace: "mitchpond", author: "Mitch Pond") {
    ...
    tiles (scale: 2) {
        ...
        standardTile("Panic", "device.contact", decoration: "flat", canChangeBackground: true, width: 2, height: 2) {
            state "open", label: 'Panic', icon:"st.security.alarm.alarm", backgroundColor: "#f11919", nextState:"closed"
            state "closed",  label: 'Panic', icon:"st.security.alarm.clear", backgroundColor:"#bc23230", nextState:"open"
        }
